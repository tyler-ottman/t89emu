...
std::multimap<uint32_t, uint32_t> instructionsRIS = {
	...
	{0x00000010, 0xfff5a613}, // slti a2, a1, 0xfff
	{0x00000014, 0x0ff5a593}, // slti a1, a1, 0xf
	{0x00000018, 0xfff5b613}, // sltiu a2, a1, 0xfff
	{0x0000001c, 0x0005b613}, // sltiu a2, a1, 0x0
	...
	{0x000000e0, 0x80000637}, // lui a2, 0x80000
	...
	{0x000000f8, 0x0ff00793}, // addi a5, x0, 0xff
	{0x000000fc, 0x00f62023}, // sw a5, 0(a2)
    {0x00000100, 0x01000793}, // addi a5, x0, 0x10
    {0x00000104, 0x00f62223}, // sw a5, 4(a2)
	{0x00000108, 0x00062683}, // lw a3, 0(a2)
	{0x0000010c, 0x00462683}, // lw a3, 4(a2)
	{0x00000110, 0xfe000613}, // addi a2, x0, 0xfe0
	{0x00000114, 0xfffef6b7}, // lui a3, 0xfffef
	{0x00000118, 0x00d66633}, // or a2, a2, a3
	{0x0000011c, 0x02b62023}, // sw a1, 32(a2)
	{0x00000120, 0xffff0637}, // lui a2, 0xffff0
	{0x00000124, 0x00062683} // lw a3, 0(a2)
};
